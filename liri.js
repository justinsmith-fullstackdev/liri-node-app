//Call dot env package to establish variables
...
// Go to keys.js to get TWITTER and SPOTIFY api 
var keys = require("./keys.js");
var spotify = new Spotify(keys.spotify);
var client = new Twitter(keys.twitter);

// Collect arguments entered into command line
var infoEntered = process.argv;
var action = process.argv[2];

// Transfrom arguments into a string (title or song name) 
var title = ""
...
// Cases(if/else) what actions to perform for certain arguments
switch (action) {
    case "movie-this":
        movie();
        break;
...
// ****** Movie *****
// When no movie title is selected, then Mr No Body by default
function movie() {
    if (process.argv[3] === undefined) {
        title = "Mr.+Nobody";
        movieInfo();
...
// API request to OMDB for movie information
function movieInfo() {
...
// ***** Spotify ********
// When no song title is selected, then default to Ace of Base
...
//  API request to Spotify for movie information
...
// ******** Twitter ********
// API Call to Twitter for 20 songs
function tweets() {
...
// ************* Do-What-It-Says **********
// Read random.txt file and perform action
function doIt() {
